...
parser.add_argument("Annotation_File", help="Path to annotation file (CSV) for a given chromosome.")
parser.add_argument("Annotation_File_Bin_Size", help="Bin Size of the annotation file provided. ( ex: 100, 200)")
parser.add_argument("CoRSIV_File", help="Path to CoRSIV file (CSV) for a given chromosome. Columns of CoRSIV file should be file chr, start, end, cpg_count, id, ... and should be in 1-based coordinates")
